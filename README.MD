...
* [Pieces](https://pieces.app) - Another free AI-Powered software for developers
...
* [Pyrogram](https://docs.pyrogram.org) - Pyrogram is an elegant, modern and asynchronous Telegram MTProto API framework in Python for users and bots
...
* [Perspective](https://perspectiveapi.com) - Perspective API can help mitigate toxicity and ensure healthy dialogue online
* [Nager.Date](https://date.nager.at) - Nager.Date is an open source project which provides a simple way to query the holidays of over 100 countries, also it is possible to query long weekends
...
* [Repo2txt](https://github.com/pde-rent/repo2txt) - Dump an entire github repository inside a descriptive file to be used as llm input or training data
* [Botasaurus](https://github.com/omkarcloud/botasaurus) - The All in One Framework to build Awesome Scrapers
...
* [Hugo](https://gohugo.io/) - Hugo is another one open-source static site generator
* [Static Shock](https://staticshock.io/) - Static Shock is a static site generator for Dart
...
* [MIX](https://pub.dev/packages/mix) - An expressive way to effortlessly build design systems in Flutter
...
* [Scratcher](https://pub.dev/packages/scratcher) - Scratch card widget which temporarily hides content from the user
* [Random Text Reveal](https://pub.dev/packages/random_text_reveal) - A text animation package with random text reveal effect where the text reveals itself letter by letter
...
* [Patrol](https://pub.dev/packages/patrol) - Powerful Flutter-native UI testing framework overcoming limitations of existing Flutter testing tools
* [Pubviz](https://pub.dev/packages/pubviz) - A tool to visualize package dependencies and version constraints in your Dart project
...
* [Rnd](https://pub.dev/packages/rnd) - Extension methods & helpers for Random, and a globally accessible instance
...
* [Shorebird](https://github.com/shorebirdtech/shorebird) - Code push for Flutter and other tools for Flutter businesses
...
* [Nested](https://pub.dev/packages/nested) - A Flutter Widget which helps nest multiple widgets without needing to manually nest them
* [Flutter Adaptive UI](https://pub.dev/packages/flutter_adaptive_ui) - A library that helps implement adaptive UI (based on OS, Screen size, ...)
* [Sizer](https://pub.dev/packages/sizer) - A Flutter plugin for easily make Flutter apps responsive (or use MediaQuery)
* [Responsive Sizer](https://pub.dev/packages/responsive_sizer) - Responsive Sizer helps implement a reponsive layout by providing helper widgets and extensions
...
* [Flutter Staggered Animations](https://pub.dev/packages/flutter_staggered_animations) - Easily add staggered animations to your ListView, GridView, Column and Row children
...
* [Flutter Form Builder](https://pub.dev/packages/flutter_form_builder) - This package helps in creation of forms in Flutter by removing the boilerplate code, reusing validation, react to changes, and collect final user input
